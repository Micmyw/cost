...
<div>
	...
	<form action="expense/MyExpenseQuery" id="f1" method="post" class="form-inline">
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="expenseList" pagesize="10" requestURI="expense/MyExpenseQuery">
				...
				<d:column property="expenseTotal" title="报销总金额"></d:column>
				 <%--<d:column value="查看详情" title="查看详情" href="expense/expenseDetailQuery"  paramId="expenseId" paramProperty="expenseId"></d:column>--%>
