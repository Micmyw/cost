...
<div>
	...
	<form action="expense/expenseManagerQuery" id="f1" method="post" class="form-inline">
		<div class="row alert alert-info" style="margin: 0px; padding: 5px;">
			...
			<label>报销人:</label> <input type="text" class="form-control"     name="userName" value="${expense.userName }" placeholder="请输入报销人姓名" />
				<%--设置fmt是为了将date类型的转换成string类型--%>ose
		...
		<div class="row" style="padding: 15px;">
			<%--接受回显值，expenseList   requestURI表示下一页地址--%>
			<d:table class="table table-hover table-condensed" name="expenseList" pagesize="10" requestURI="expense/expenseManagerQuery">
				...
				<d:column property="expenseStateStr" title="报销状态"></d:column>
				<d:column property="expenseTotal" title="报销总金额"></d:column>
				<d:column value="审核" title="审核" href="expense/expenseManageAudit"  paramId="expenseId" paramProperty="expenseId"></d:column>
