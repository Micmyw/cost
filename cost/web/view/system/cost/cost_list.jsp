...
$(function(){
	...
	$("#del").click(function(){
			...
			if(confirm("确认要删除！")){
				$("#f1").prop("action","system/costDeletes");
				$("#f1").submit();//提交表单
			}
...
<div>
	...
	<form action="system/costQuery" id="f1" method="post" class="form-inline">
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="costList" pagesize="3" requestURI="system/costQuery">
