...
$(function(){
	...
	$("#userAccount").blur(function(){
		$.ajax({
			...
			//回调函数，将post方法中out出来的对象赋予resp
			success:function(resp){
				if(resp.state==0){  //如果账号存在
					$("#accountinfo").html(resp.tip);  //将该标签的innerhtml设置为tip值
...
<form action="system/useradd" id="f1" method="post" class="form-horizontal">
